...
export default class GameScene2 extends Phaser.Scene {
  ...
  createMap() {
    // create our map
    this.bgMap = this.make.tilemap({ key: "level2" }); // key from the json file
    ...
    this.backgroundLayer = this.bgMap.createLayer(
      "Background",
      this.tiles,
      0,
      0
